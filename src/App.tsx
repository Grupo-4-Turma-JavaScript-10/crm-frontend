...
import FormEstudante from './components/estudante/formestudante/FormEstudante';
...
function App() {
  return (
    <>
      ...
      <BrowserRouter>
        <Navbar />
        <main className="sm:ml-50 mt-20 p-4 min-h-screen border border-gray-500 rounded-t-lg overflow-auto">
          <Routes>
            ...
            <Route path="/estudantecadastrar" element={<FormEstudante />} />
            <Route path="/estudanteeditar/:id" element={<FormEstudante />} />
          </Routes>
        </main>
      </BrowserRouter>
    </>
